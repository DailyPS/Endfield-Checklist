...
const initialRoutines = [
  ...
  { id: 'd_03', type: 'daily', title: '선검 연무 보상 연산', completed: false, current: 0, max: 3, isCounter: true },
  { id: 'd_04', type: 'daily', title: '무릉 변동 물자 거래', completed: false },
  { id: 'd_05', type: 'daily', title: '무릉성 도심 저장고 노드 배달', completed: false },
  { id: 'd_06', type: 'daily', title: '실험 구역 저장고 노드 배달', completed: false },
  { id: 'd_07', type: 'daily', title: '4번 협곡 변동 물자 거래', completed: false },
  { id: 'd_08', type: 'daily', title: '오리지늄 연구 구역 저장고 노드 배달', completed: false },
  { id: 'd_09', type: 'daily', title: '광맥 구역 저장고 노드 배달', completed: false },
  { id: 'd_10', type: 'daily', title: '에너지 공급 고지 저장고 노드 배달', completed: false },
  { id: 'd_11', type: 'daily', title: '제강호 친구 방문 지원', completed: false },
  { 
    id: 'd_12', 
    type: 'daily', 
    title: 'SKPORT 출석 체크', 
  ...
  { 
    ...
    subTasks: [
      ...
      { id: 'd_st_02', title: '이성을 60포인트 소모', points: 10, completed: false },
      { id: 'd_st_03', title: '이성을 120포인트 소모', points: 10, completed: false },
      { id: 'd_st_04', title: '적을 누적 10명 처치', points: 20, completed: false},
      { id: 'd_st_05', title: '오퍼레이터를 1회 업그레이드', points: 20, completed: false},
      { id: 'd_st_06', title: '무기를 1회 업그레이드', points: 20, completed: false},
      { id: 'd_st_07', title: '장비 제작을 1회 진행', points: 40, completed: false},
      { id: 'd_st_08', title: '5회 채집', points: 20, completed: false},
      { id: 'd_st_09', title: '간편 제작을 1회 진행', points: 20, completed: false},
      { id: 'd_st_010', title: '임의의 오퍼레이터 1명에게 선물을 1회 증정', points: 40, completed: false},
      { id: 'd_st_011', title: '임의 지역의 물자 관리에서 변동 수요 물자를 1회 구매', points: 40, completed: false},
      { id: 'd_st_012', title: '제강호에서 생산품 또는 단서를 1회 수집', points: 40, completed: false},
      { id: 'd_st_013', title: '일상 파견 임무를 1회 완료', points: 80, completed: false },
    ]
  },
  ...
  { 
    ...
    completed: false,
    subTasks: [
      { id: 'w_260914_st_01', title: '[통합 지원 · 버블 출동!]에서 지원 성과권을 누적 300000개 획득', points: 5, completed: false },
      { id: 'w_260914_st_02', title: '[티프로스의 활터] 일상 훈련에서 성급 누적 9개 획득', points: 5, completed: false},
      { id: 'w_260914_st_03', title: '누적 3일 로그인', points: 2, completed: false },
      { id: 'w_260914_st_04', title: '이성 누적 1500 포인트 소모', points: 2, completed: false},
      { id: 'w_260914_st_05', title: '물자 관리 시스템에서 변동 물자 누적 1회 구매', points: 1, completed: false },
      { id: 'w_260914_st_06', title: '크레딧 거래소에서 상품 누적 15회 구매', points: 1, completed: false },
      { id: 'w_260914_st_07', title: '제강호에서 오퍼레이터에게 선물 10회 증정', points: 1, completed: false},
      { id: 'w_260914_st_08', title: '적 누적 150명 처치', points: 1, completed: false},
      { id: 'w_260914_st_09', title: '물리 이상/아츠 폭발/아츠 이상 효과 누적 100회 발동', points: 1, completed: false},
      { id: 'w_260914_st_10', title: '에너지 응집점 15회 제거', points: 1, completed: false},
    ]
  },
]
