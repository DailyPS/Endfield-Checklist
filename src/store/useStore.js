...
const initialRoutines = [
  ...
  { 
    ...
    completed: false,
    subTasks: [
      { id: 'w_260907_st_01', title: '[티프로스의 활터] 일상 훈련에서 성급 누적 9개 획득', points: 5, completed: false },
      { id: 'w_260907_st_02', title: '4번 협곡 또는 무릉 지역에서 누적 35회 채집', points: 5, completed: false},
      { id: 'w_260907_st_03', title: '물자 관리 시스템에서 변동 물자 누적 1회 구매', points: 2, completed: false },
      { id: 'w_260907_st_04', title: '크레딧 거래소에서 상품 누적 15회 구매', points: 2, completed: false},
      { id: 'w_260907_st_05', title: '제강호에서 오퍼레이터에게 선물 10회 증정', points: 1, completed: false },
      { id: 'w_260907_st_06', title: '적 누적 150명 처치', points: 1, completed: false },
      { id: 'w_260907_st_07', title: '물리 이상/아츠 폭발/아츠 이상 효과 누적 100회 발동', points: 1, completed: false},
      { id: 'w_260907_st_08', title: '에너지 응집점 15회 제거', points: 1, completed: false},
      { id: 'w_260907_st_09', title: '누적 3일 로그인', points: 1, completed: false},
      { id: 'w_260907_st_10', title: '이성 누적 1500 포인트 소모', points: 1, completed: false},
    ]
  },
]
