...
const initialRoutines = [
  ...
  { id: 'd_05', type: 'daily', title: '실험 구역 저장고 노드 배달', completed: false },
  { id: 'd_06', type: 'daily', title: '4번 협곡 변동 물자 거래', completed: false },
  { id: 'd_07', type: 'daily', title: '오리지늄 연구 구역 저장고 노드 배달', completed: false },
  { id: 'd_08', type: 'daily', title: '광맥 구역 저장고 노드 배달', completed: false },
  ...
  { 
    ...
    completed: false,
    subTasks: [
      { id: 'w_260601_st_01', title: '4번 협곡 또는 무릉 지역에서 프토토콜 보물 상자 누적 3개 개방', points: 5, completed: false },
      { id: 'w_260601_st_02', title: '임의의 지역 관리권 누적 12000000장 획득', points: 5, completed: false},
      { id: 'w_260601_st_03', title: '제강호에서 오퍼레이터에게 선물 증정 10회', points: 2, completed: false },
      { id: 'w_260601_st_04', title: '적 누적 150명 처치', points: 2, completed: false},
      { id: 'w_260601_st_05', title: '물리 이상/아츠 폭발/아츠 이상 효과 누적 100회 발동', points: 1, completed: false },
      { id: 'w_260601_st_06', title: '에너지 응집점 15회 제거', points: 1, completed: false },
      { id: 'w_260601_st_07', title: '누적 3일 로그인', points: 1, completed: false},
      { id: 'w_260601_st_08', title: '이성 누적 1500 소모', points: 1, completed: false},
      { id: 'w_260601_st_09', title: '물자 관리 시스템에서 변동 물자 누적 1회 구매', points: 1, completed: false},
      { id: 'w_260601_st_10', title: '크레딧 거래소에서 상품 누적 15회 구매', points: 1, completed: false},
    ]
  },
]
